...
class JointStateSubscriber(Node):
    ...
    def get_target_joint_info(self):
        ...
        self.target_joint_pos = math.sin(current_time)*1
    ...
    def calculate_pd_torque(self, joint_pos, joint_vel, target_joint_pos, target_joint_vel):
        # target_joint_pos = self.get_joint_info(self)[0]
        torque = (KP * (target_joint_pos - joint_pos)) + (KD * (target_joint_vel - joint_vel)) + 0 
        return torque
    ...
    def pd_loop(self):
        ...
        self.torque_history.append(self.pd_torque)
        self.print_info()
        self.publish_torque(self.torque_history.popleft())
